...
<div class="container">
        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-6">
            <div class="panel panel-default">
                <div class="panel-heading c-list">
                    <span class="title">Coupons Alcolock:</span>
                ...
                <?php   $counter=1;
                        ...
                        echo "<li class='list-group-item' id='".$row["coupon_id"]."'>
                        
                        <div class='col-xs-12 col-sm-9'>
                            <span class='name'>".$row["name"]."</span><br/>
                            
                            <div class='discountNum'>".$row["discount"]."% discount</div>
                            <button onclick='sendName(".$row["coupon_id"].")'>delete</button>
                            <div><a href='addcoupon.php?name=".$row["name"]."'>edit</a></div>
                            <div>
                        </div>
    ...
    <script src="includes/coupons/couponsJS.js"></script>
</div>
</body>
